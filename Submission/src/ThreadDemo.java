 ...
 * Date: 13/04/2016 
 * Program Description: extending the thread class.
 *         				create two instances of this class. run their threads. each time
 *         				their thread is run print their assigned name.
 */
...
public class ThreadDemo extends Thread {
	...
	public ThreadDemo(String name) {
		...
		this.name = name;
		// prints the thread is created although it actually isn't until the
	...
	public void start() {
		...
		if (t == null) {
			// if not the using the thread constructor and this class and class
			// variable string name create a new thread
