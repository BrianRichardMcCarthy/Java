 ...
 * Program Name: BorderWindowEvents
 * Program Description: Create a new class BorderWindowEvents.java 
 * 						program to display relevant JOptionPane output 
 * 						messages for the two command buttons in the Application.
 * 						Include an event listener for the JTextField component. 
 * 						Output a suitable message when the RETURN key is pressed.
 * */
